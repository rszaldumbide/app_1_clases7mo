                        ...
                        <div class="my-5 text-center">
                            ...
                            <form action="<?php echo base_url() . "index.php/envioDatosPrueba" ?>" method="GET" enctype="multipart/form-data">
                                ...
                                <div class="input-group my-3">
                                    ...
                                    <input required type="text" maxlength="10" onkeyup="verificar()" onkeypress="return ingresoNumeros(event);" class="form-control" name="cedula" id="cedula" placeholder="Ingrese su número de cédula">
                                </div>
                                <div class="input-group my-3">
